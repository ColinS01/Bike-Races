...
class MyUser(AbstractUser):
    ...
    owned_races = models.ManyToManyField('Race', blank=True, related_name='owned_races')
    participating_races = models.ManyToManyField('Race', blank=True, related_name='participating_races')
...
class Race(models.Model):
    ...
    owner = models.ForeignKey(MyUser, related_name='owner', on_delete=models.CASCADE, default='')
